void plot_MPVs(double energy_per_cm, std::vector<double> x_values, std::vector<landau_fit_result> landau_fit_result_vector, std::vector<double> penetration_depths, bool use_amplitude){
    gStyle->SetOptFit(0);
